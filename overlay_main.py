...
ANOMALY_TYPES    = [
    ...
    "Object Movement", "Object Replacement", "Other"
]
...
class AnomalyNotification(QtWidgets.QWidget):
        def __init__(self, message):
            ...
            self.adjustSize()
            self.move(50, 50)  # top-left corner; adjust if needed

            QtCore.QTimer.singleShot(4000, self.close)  # Auto-close in 4 seconds
